  ...
  function install() {
    ...
    footer.innerHTML = `
      <div class="nm-site-footer__grid">
        <div class="nm-site-footer__about"><div class="nm-site-footer__brand"><img src="/newmedia-logo.png" alt=""><strong>NEW MEDIA</strong></div><p data-nm-label="desc"></p><div class="nm-site-footer__social"><a href="https://www.instagram.com/newmedia.hc/" target="_blank" rel="noopener noreferrer" aria-label="Instagram. newmedia.hc" title="Instagram @newmedia.hc"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5"></rect><circle cx="12" cy="12" r="4"></circle><circle cx="17.5" cy="6.5" r="1"></circle></svg></a><a href="https://www.tiktok.com/@newmedia.website" target="_blank" rel="noopener noreferrer" aria-label="TikTok. newmedia.website" title="TikTok @newmedia.website"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M14 4v10.2a4.2 4.2 0 1 1-3-4V7.1a7.3 7.3 0 0 0-5.8 7.1A7.2 7.2 0 1 0 17 8.6 7 7 0 0 0 21 10V6.8A4.8 4.8 0 0 1 17 4Z"></path></svg></a><a href="https://x.com/newmediawebsite" target="_blank" rel="noopener noreferrer" aria-label="X. newmediawebsite" title="X @newmediawebsite"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 4l14 16M19 4 5 20"></path></svg></a></div><p class="nm-site-footer__rights" data-nm-label="rights"></p></div>
